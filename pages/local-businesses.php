...
<section class="mx-auto max-w-editorial px-6 pt-20 pb-20">
    <div class="running-head" aria-hidden="true">
        <span>shane logsdon &mdash; local businesses</span>
...
<section class="mx-auto max-w-editorial px-6 pb-20">
    <div class="grid grid-cols-12 gap-6 border-t border-rule pt-12">
        <div class="col-span-12 sm:col-span-3">
            <p class="smallcaps-lg">the numbers</p>
            <p class="folio mt-3"><span>case study &middot; oldham county, ky &middot; april 2026</span></p>
        </div>
        <div class="col-span-12 space-y-8 sm:col-span-9">
            <div class="grid grid-cols-1 sm:grid-cols-3">
                <div class="border-t border-rule py-8 sm:border-t-0 sm:border-r sm:pr-6">
                    <p class="font-display text-6xl font-normal leading-none text-foreground">112</p>
                    <p class="mt-4 text-[0.95rem] leading-relaxed text-muted-foreground">new businesses registered in Oldham County in April 2026</p>
                </div>
                <div class="border-t border-rule py-8 sm:border-t-0 sm:border-r sm:px-6">
                    <p class="font-display text-6xl font-normal leading-none text-foreground">40</p>
                    <p class="mt-4 text-[0.95rem] leading-relaxed text-muted-foreground">had no Google listing whatsoever, meaning they were invisible from day one</p>
                </div>
                <div class="border-t border-rule py-8 sm:border-t-0 sm:pl-6">
                    <p class="font-display text-6xl font-normal leading-none text-foreground">30</p>
                    <p class="mt-4 text-[0.95rem] leading-relaxed text-muted-foreground">had a Google profile but no working website attached to it</p>
                </div>
            </div>
